...
package com.mycompany.exercicio12_26;
...
public class Exercicio12_26 {
    ...
    public static void main(String[] args) {
      ...
      Empresa e1 = new Empresa("Tech Solutions");
        ...
        Projeto p1 = new Projeto(    "Sistema Bancario",     101,   "Projeto em Java");

        Projeto p2 = new Projeto("Pesquisa de Mercado", 102, "Analise de dados" );

        Projeto p3 = new Projeto(     "Aplicativo Mobile", 103, "Projeto Android");
